...
from hans_processors import (
    hans_convert_examples_to_features as convert_examples_to_features,
)
...
def load_and_cache_examples(args, task, tokenizer, evaluate=False):
    ...
    dataset = TensorDataset(
        all_input_ids, all_attention_mask, all_token_type_ids, all_labels, all_pair_ids,
    )
